...
- Rule 0 (UI): Before any UI change, read the required documentation in `design-system/`:
...
- Exception: follow `design-system/07-components.md` for shadcn/prompt-kit registry commands (uses `npx shadcn add ...`).
